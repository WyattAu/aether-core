...
class CapabilitySet:
    ...
    def has_network(self) -> bool:
        ...
        """
        return (
            Capability.NETWORK_OUTBOUND in self._caps
            or Capability.NETWORK_INBOUND in self._caps
        )
    ...
    def has_state(self) -> bool:
        ...
        """
        return (
            Capability.STATE_READ in self._caps or Capability.STATE_WRITE in self._caps
        )
