...
from aether_sdk.validation.validators import (
    EMAIL_PATTERN,
    UUID_PATTERN,
...
def validate_string(value: Any, min_length: int = 0, max_length: Optional[int] = None,
    ...
    return _orig_validate_string(value, min_length=min_length, max_length=max_length, pattern=pattern)
...
def validate_list(value: Any, min_length: int = 0, max_length: Optional[int] = None,
    ...
    return _orig_validate_list(value, min_length=min_length, max_length=max_length,
...
def validate_dict(value: Any, required_keys: Optional[List[str]] = None,
    ...
    return _orig_validate_dict(value, required_keys=required_keys, optional_keys=optional_keys)
