...
class TestHealthCheckerRunAll:
    ...
    @pytest.mark.asyncio
    async def test_run_all_with_degraded(self, health_checker, healthy_check, degraded_check):
    ...
    @pytest.mark.asyncio
    async def test_run_all_with_critical_unhealthy(self, health_checker, healthy_check, unhealthy_check):
    ...
    @pytest.mark.asyncio
    async def test_run_all_with_non_critical_unhealthy(self, health_checker, healthy_check, unhealthy_check):
...
class TestHealthCheckerProbes:
    ...
    @pytest.mark.asyncio
    async def test_get_readiness_non_critical_unhealthy(self, health_checker, healthy_check, unhealthy_check):
