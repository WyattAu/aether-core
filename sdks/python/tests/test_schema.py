...
class TestJsonSchemaValidatorCompatibility:
    ...
    def test_compatibility_same_schema(self):
        ...
        assert result in (Compatibility.FORWARD, Compatibility.BACKWARD, Compatibility.FULL)
...
class TestSchemaIntegration:
    ...
    async def test_full_schema_lifecycle(self):
        ...
        assert compat in (Compatibility.BACKWARD, Compatibility.FORWARD, Compatibility.FULL)
