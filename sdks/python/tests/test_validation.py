...
class TestValidateUrl:
    ...
    def test_invalid_urls(self):
        ...
        assert validate_url("ftp://example.com", allowed_schemes=["http", "https"]) is False
...
class TestValidateDict:
    ...
    def test_optional_keys(self):
        ...
        assert validate_dict(data, required_keys=["name"], optional_keys=["nickname"]) is True
        
        # Extra key not allowed
        data = {"name": "test", "extra": "value"}
        assert validate_dict(data, required_keys=["name"], optional_keys=["nickname"]) is False
...
class TestValidator:
    ...
    def test_when_validation(self):
        ...
        result = validator.when(
            True,
            lambda v: v.required("admin_code", None)  # None should fail required
        )
...
class TestValidatedDecorator:
    ...
    def test_validated_decorator_failure(self):
        ...
        result = greet("ab")  # Too short - check what happens
