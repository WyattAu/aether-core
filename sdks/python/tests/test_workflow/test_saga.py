...
class TestSaga:
    ...
    def test_add_steps(self):
        s = Saga("test-saga").step("step1").step("step2").step("step3")
    ...
    def test_get_step(self):
        s = Saga("test-saga").step("step1").step("step2")
...
class TestSagaExecutor:
    ...
    async def test_no_compensation_for_no_completed_steps(self, executor):
        ...
        no_comp_saga = (
            Saga("no-comp-saga").step("fail-first").action(fail_immediately).build()
        )
